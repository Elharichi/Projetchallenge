...
<?php
 if(isset($_GET["action"])) {
    if($_GET["action"]=="delete"){
        foreach ($_SESSION["my_nearby_shop"] as $keys => $values) {
            if($values["item_id"] ==$_GET["id"]){
                unset($_SESSION["my_nearby_shop"][$keys]);
...
<html>
<head>
	<title> My Nearby Shop</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
</head>
<body>
	<h2 style="font-size:6vw" "font-style: oblique";> <center> My nearby Shops </center> </h2>
	<div class="clear:both"></div>
     ...
     <div class="table-responsive">
     	<table class="table table-bordred">
     		...
     		<?php
     		   if (!empty($_SESSION["my_nearby_shop"])) {
            ...
            <tr>
            	...
            	<td><a href="nearbyshop.php?action=delete&id=<?php echo $values["item_id"]; ?>"><button type="submit" class="btn btn-danger">Supprimer</button></a></td>
            </tr>
